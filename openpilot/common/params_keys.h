...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"UpdaterCurrentDescription", {PERSISTENT, STRING}},
    {"UpdaterCurrentReleaseNotes", {PERSISTENT, BYTES}},
    {"UpdaterFetchAvailable", {PERSISTENT, BOOL}},
    {"UpdaterNewDescription", {CLEAR_ON_MANAGER_START, STRING}},
    {"UpdaterNewReleaseNotes", {CLEAR_ON_MANAGER_START, BYTES}},
    {"UpdaterState", {PERSISTENT, STRING}},
    {"UpdaterTargetBranch", {PERSISTENT, STRING}},
    ...
    {"SuperVideoStream", {PERSISTENT | BACKUP, BOOL, "0"}},
