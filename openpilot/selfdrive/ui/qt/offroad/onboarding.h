...
class SunnylinkConsentPage : public QFrame {
  Q_OBJECT

public:
  explicit SunnylinkConsentPage(QWidget *parent = 0);
...
private:
  ...
  QPushButton *primary_btn = nullptr;
  QPushButton *secondary_btn = nullptr;
  QPushButton *danger_btn = nullptr;
...
public:
  ...
  virtual inline bool completed() const { return accepted_terms && training_done && sunnylink_consent_done; }

protected:
  virtual void updateActiveScreen();

  Params params;
  bool accepted_terms = false, training_done = false, sunnylink_consent_done = false;
