...
from openpilot.selfdrive.ui.sunnypilot.onroad.lane_center_status import LaneCenterStatusRenderer
...
class HudRendererSP(HudRenderer):
  def __init__(self):
    ...
    self.lane_center_status_renderer = LaneCenterStatusRenderer()
  ...
  def _update_state(self) -> None:
    ...
    self.lane_center_status_renderer.update()
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    self.lane_center_status_renderer.render(rect)
