...
// Color tokens aligned to 2026 native raylib standard
namespace ColorTokens {
  constexpr auto TOGGLE_ON_BG = "#1C65BA";        // rgb(28, 101, 186)
  constexpr auto TOGGLE_OFF_BG = "#393939";        // rgb(57, 57, 57)
  constexpr auto TOGGLE_DISABLED_ON = "#25466B";   // rgb(37, 70, 107)
  constexpr auto TOGGLE_DISABLED_OFF = "#272727";  // rgb(39, 39, 39)
  constexpr auto BTN_OFF_BG = "#393939";           // rgb(57, 57, 57)
  constexpr auto BTN_PRESSED_BG = "#4A4A4A";       // rgb(74, 74, 74)
  constexpr auto BTN_DISABLED_BG = "#121212";      // rgb(18, 18, 18)
  constexpr auto BTN_DISABLED_TEXT = "#5C5C5C";    // rgb(92, 92, 92)
}  // namespace ColorTokens
