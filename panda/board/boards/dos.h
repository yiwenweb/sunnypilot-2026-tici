...
// NOTE: adapted to the 2026 `struct board` layout.
//  - removed: fan_max_rpm / fan_max_pwm / fan_stall_recovery (2026 dropped the
//    RPM PID + stall-recovery fan controller in favor of direct PWM)
//  - added:   has_fan (replaces the old "fan_max_rpm > 0" test in fan_tick)
//  - led_pwm_channels intentionally left zero -> led.h falls back to GPIO mode,
//    which is how dos LEDs have always been driven
board board_dos = {
