...
static bool can_set_speed(uint8_t can_number) {
  ...
  // 2026: can_silent is a plain bool (was an int bitmask with ALL_CAN_SILENT in 0.10.1/2025)
  ret &= llcan_set_speed(
    CANx,
...
void can_rx(uint8_t can_number) {
  ...
  while ((CANx->RF0R & CAN_RF0R_FMP0) != 0U) {
    ...
    // 2026 removed can_live/pending_can_live; liveness is shown via LED_BLUE below
